    ...
    public class EditorialController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Editoriales != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Editoriales'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre_Editorial,Telefono_Editorial,Contacto_Editorial")] Editorial editorial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre_Editorial,Telefono_Editorial,Contacto_Editorial")] Editorial editorial)
        {
            if (id != editorial.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Editoriales'  is null.");
            }
            var editorial = await _context.Editoriales.FindAsync(id);
            if (editorial != null)
            {
